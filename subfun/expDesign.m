function [cfg] = expDesign(cfg, displayFigs)
    ...
    [~, CONDITION1_INDEX, CONDITION2_INDEX] = assignConditions(cfg);
    ...
    numTargetsForEachBlock(CONDITION1_INDEX) = shuffle(targetPerCondition);
    numTargetsForEachBlock(CONDITION2_INDEX) = shuffle(targetPerCondition);
